...
namespace ByteBank.Models
{
    ...
    /// </summary>
    public class CurrentAccount : FuncionalidadesEDeclaracoesDaContaCorrente
    {
        ...
        /// <param name="numeroDaConta">Representa o valor da propriedade <see cref="_numeroDaConta"/> </param>
